...
static const float knee_side_sign[4] = {-.6333f, .6333f, -.6333f, .6333f};


static const float abad_offset[4] = {0.439f, 0.035f, -0.f, -0.038f};
static const float hip_offset[4]  = {1.531f, -1.494f, -1.440f, 1.500f};
static const float knee_offset[4] = {4.183f, -4.300f, -4.200f, 4.200f};
